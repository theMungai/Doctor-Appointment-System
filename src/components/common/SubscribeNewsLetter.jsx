  ...
  return (
    <div className='font-dmsans py-[60px] w-[40%] mx-auto text-center'>
      ...
      <div className="subscribe-email flex items-center justify-around ">
        <input type="text" placeholder='Enter your email' className='border-none outline-none placeholder:text-[14px] font-dmsans font-normal text-[#555555] w-3/4 px-2.5' required />
