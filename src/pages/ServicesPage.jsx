...
function CustomerFeedBack({image}){
  return(
    <div className = "p-7 border border-[#cfcfcf] font-montserrat w-[30%]">
      ...
      <Layout>
        ...
        <div className = "font-montserrat px-[130px]">
          ...
          <div className="flex justify-between items-center" >
            <CustomerFeedBack image={1}/>
            <CustomerFeedBack image={2}/>
            <CustomerFeedBack image={3}/>
          </div>
        </div>
      </Layout>
    </div>
